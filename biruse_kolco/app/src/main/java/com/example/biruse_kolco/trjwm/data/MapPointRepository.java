...
public final class MapPointRepository {
    ...
    private static List<MapPoint> buildPoints() {
        ...
        points.add(p("bolkhov", "Болхов", "Административный центр Болховского района", 53.4500, 36.0000, "district"));
        ...
        points.add(p("dmitrov", "Дмитровск", "Лесной юго-запад области", 52.5000, 35.1500, "district"));
        ...
        points.add(p("mcensk", "Мценск", "Северный центр района", 53.2800, 36.5800, "district"));
        ...
        points.add(p("trosna", "Тросна", "Южный районный центр", 52.4442, 35.7814, "district"));
        points.add(p("trosna", "Река Тросна", "Река в Троснянском районе", 52.4405, 35.7950, "river"));
